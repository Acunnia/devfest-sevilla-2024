...
export default function Jobs({ jobs }: Props) {
  ...
  return (
    <Page meta={meta}>
      <Layout>
        <Header hero="Información Legal del DevFest Sevilla 2024" description="En esta página encontrarás información legal sobre el DevFest Sevilla 2024." />
  ...
  */}
        <div className="m-8 shadow-md border rounded-lg border-white">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              En el marco del DevFest Sevilla 2024, nos gustaría informarte sobre los derechos de uso de imagen. Como evento público centrado en la tecnología, es probable que se capturen imágenes, fotografías y videos durante las diversas actividades y conferencias programadas. Queremos asegurarte que estos medios visuales pueden ser utilizados con propósitos promocionales y educativos, tanto durante el evento como en publicaciones posteriores en diversos canales en línea.
            </p>
            <p className="mb-4">
              1.1 Todos los asistentes al DevFest Sevilla 2024 comprenden y aceptan que las imágenes capturadas durante el evento pueden incluir sus rostros, atuendos y participación en actividades.
            </p>
            <p className="mb-4">
              1.2 Los organizadores del evento, GDG Sevilla, se reservan el derecho de utilizar estas imágenes con fines promocionales, publicitarios y educativos, ya sea en línea o fuera de línea, sin requerir consentimiento adicional.
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              1.4 Al participar en el DevFest Sevilla 2024, los asistentes renuncian a cualquier reclamación por derechos de privacidad relacionados con la captura y uso de sus imágenes.
            </p>
            <p className="mb-4">
  ...
  */}
          <section className="mb-8">
            ...
            <p className="mb-4">
              En GDG Sevilla, organizadores del DevFest Sevilla 2024, estamos comprometidos con la protección de tu privacidad. Esta política de privacidad detalla cómo recopilamos, usamos, divulgamos y protegemos la información personal que puedas proporcionarnos durante el evento y en relación con él.
            </p>
            <h3 className="text-lg font-semibold mb-4">1. Recopilación de Información</h3>
            <p className="mb-4">
              1.1 Durante el registro para el DevFest Sevilla 2024, solicitaremos cierta información personal, como tu nombre, dirección de correo electrónico y detalles de contacto. Esta información se utiliza para gestionar tu participación en el evento y enviar comunicaciones relacionadas.
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              1.3 Toda la información recopilada se trata con confidencialidad y se utiliza únicamente con el propósito de mejorar tu experiencia en el DevFest Sevilla 2024.
            </p>
  ...
  */}
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              La Política de Cookies del DevFest Sevilla 2024 describe cómo utilizamos las cookies y tecnologías similares en nuestro sitio web. Al utilizar nuestro sitio, aceptas el uso de cookies de acuerdo con esta política.
            </p>
  ...
  */}
          <section className="mb-8">
            ...
            <p className="mb-4">
              El DevFest Sevilla 2024, organizado por GDG Sevilla, se ofrece "tal cual" y "según disponibilidad". Nos esforzamos por proporcionar información precisa y actualizada, pero no garantizamos la precisión, integridad o idoneidad de la información y materiales ofrecidos en el evento para ningún propósito particular.
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              GDG Sevilla no será responsable de ningún daño directo, indirecto, incidental, consecuente o punitivo resultante de la participación en el DevFest Sevilla 2024, incluyendo pero no limitado a pérdida de datos, interrupciones de servicio o daños a la propiedad.
            </p>
            <p className="mb-4">
              Al registrarte y participar en el evento, aceptas liberar de responsabilidad a GDG Sevilla y a sus afiliados, patrocinadores, colaboradores y organizadores de cualquier reclamación o demanda relacionada con tu participación en el DevFest Sevilla 2024.
            </p>
            <p className="mb-4">
              Este descargo de responsabilidad se aplica a toda la información proporcionada en el evento, ya sea presentada por GDG Sevilla o por terceros.
            </p>
          </section>
